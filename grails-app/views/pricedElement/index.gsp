...
<html>
    ...
    <body>
        <a href="#list-pricedElement" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
        ...
        <div id="list-pricedElement" class="content scaffold-list" role="main">
            ...
            <f:table collection="${pricedElementList}" />
