<div ng-controller='galleryController' user-images id="0">
    <div class='row fork-gallery-container'>
           ...
           <div class='col-md-12'>
               <div style='position:relative;display:inline-block; margin: 5px; width:100px; height:200px;line-height: 200px;'>
               ...
               <div user-image-wrapper style='position:relative;display:inline-block; margin: 5px;' ng-repeat='image in images'>
                   <img ng-style='imageStyle()' style='border:1px #777 solid;' ng-src='/user/{{id}}/image/{{image}}' user-image/>
