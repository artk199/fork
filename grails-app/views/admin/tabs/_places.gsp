...
<div class="page-section dark-section" id="places-pending-owners">
    <div class="row">
        <div class="col-md-2 col-sm-2 col-xs-1 hidden-xs"></div>
        <div class="col-md-8 col-sm-8 col-xs-11">
            <h3><g:message code="admin.tabs.places.adminRequest"/></h3>

            <g:if test="${pendingObjectAdmins.size() == 0}">
                <p>
                    <g:message code="admin.tabs.places.noRequestByUser"/>
                </p>
            </g:if>
            <g:else>
                <table class="table table-striped text-left sortable">
                    <caption>
                        <span class="pull-right">
                            <span class="glyphicon glyphicon-th"></span>
                            <g:message code="default.count" args="[pendingObjectAdmins.size()]" />
                        </span>
                    </caption>
                    <thead>
                    <tr>
                    ...
                    <tbody>
                    <g:each in="${pendingObjectAdmins}" var="place" >
                        <tr>
                            <td class='col-md-2 col-sm-2 col-xs-2'>
                                <g:if test="${place.owner}">
                                    <a href="/user/show/${place.owner.id}">
                                        ${place.owner}
                                    </a>
                                </g:if>
                                <g:else>
