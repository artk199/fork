<div id='main-content'>
    <div class="row page-section">
        ...
        <div class="col-md-5 col-sm-5 col-lg-5 col-xs-7 text-left">
            <h2>
    ...
    <div class="row page-section blue-section">
        <div class="col-md-2 col-sm-2 col-lg-2 col-xs-1 hidden-xs"></div>
        <div class="col-md-3 col-sm-3 col-lg-3 col-xs-3">
            <g:img class="img-responsive pull-right" file="home_community.png"/>
        </div>
        <div class="col-md-5 col-sm-5 col-lg-5 col-xs-7 text-left">
            <h2>
    ...
    <div class="row page-section">
        ...
        <div class="col-md-5 col-sm-5 col-lg-5 col-xs-7 text-left">
            <h2>
                <span class="glyphicon glyphicon glyphicon-question-sign pull-left"></span>
                A tutaj jakiś inny kafelek?
            </h2>
